...
Public Class venCargando
    ...
    Private Sub venCargando_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        Try
            Dim cfg As New Configuracion.empleados
            Dim listado As New ObjetosDeNegocio.empleados(cfg.Servidor, cfg.BD, cfg.Usuario, cfg.pass)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Empleados", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Finally
            Me.Close()
        End Try
