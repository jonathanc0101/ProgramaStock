...
Public Class empleados
    ...
    Property Lista As CustomSortableBindingList(Of empleado)
    ...
    Public Sub cargarLista()
        ...
        For Each item As DataRow In dt.Rows
            ...
            Dim registro As New empleado(Servidor, NombreBD, Usuario, Contrasenia)
    ...
    Public Sub eliminar(ByVal ParamID As String)
        Try
            ...
            Dim registroAEliminar As empleado

            registroAEliminar = Lista.Find("idEmpleado", ParamID)

            If IsNothing(registroAEliminar) Then

                registroAEliminar = New empleado(Servidor, NombreBD, Usuario, Contrasenia)
    ...
    Public Sub resetear()
        Lista = New CustomSortableBindingList(Of empleado)
    End Sub
End Class