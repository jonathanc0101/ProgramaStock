...
Public Class CustomSortableBindingList(Of T)
...
#Region "Public Methods"
    ...
    Public Function FindAll(ByVal propertyName As String, ByVal key As Object) As CustomSortableBindingList(Of T)
        Dim value As New CustomSortableBindingList(Of T)
        Dim descriptor As PropertyDescriptor = TypeDescriptor.GetProperties(GetType(T)).Find(propertyName, True)
